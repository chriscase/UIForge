...
test.describe('BlocksEditor Component - Basic Rendering', () => {
  ...
  test('renders toolbar/controls', async ({ page }) => {
    ...
    const toolbar = editor.locator('.uiforge-blocks-editor__toolbar, .uiforge-blocks-editor__add-button')
...
test.describe('BlocksEditor Component - Block Interaction', () => {
  ...
  test('can add a new block', async ({ page }) => {
    ...
    const addButton = editor.locator('.uiforge-blocks-editor__add-button, button:has-text("Add"), button[aria-label*="add" i]')
