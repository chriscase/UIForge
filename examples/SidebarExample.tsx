  ...
  return (
    <div className="sidebar-example">
      ...
      <p className="sidebar-example__description">
        A reusable sidebar component with three variants: static, drawer, and bottom. Each variant
        is designed for different use cases and screen sizes.
      </p>
      ...
      <section className="sidebar-example__section">
        ...
        <div className="sidebar-example__demo sidebar-example__demo--static">
          <UIForgeSidebar variant="static" width="200px" ariaLabel="Static sidebar example">
            <nav className="sidebar-example__nav">
              ...
              <ul className="sidebar-example__nav-list">
                <li>
                  <a href="#dashboard" className="uiforge-sidebar-icon-only">
                    <span>🏠</span>
                    <span>Dashboard</span>
                  </a>
                </li>
                <li>
                  <a href="#projects" className="uiforge-sidebar-icon-only">
                    <span>📁</span>
                    <span>Projects</span>
                  </a>
                </li>
                <li>
                  <a href="#settings" className="uiforge-sidebar-icon-only">
                    <span>⚙️</span>
                    <span>Settings</span>
                  </a>
                </li>
                <li>
                  <a href="#profile" className="uiforge-sidebar-icon-only">
                    <span>👤</span>
                    <span>Profile</span>
                  </a>
                </li>
          ...
          <div className="sidebar-example__content">
            ...
            <p>
              The static sidebar is perfect for desktop applications where navigation should always
              be visible. It doesn't overlay content and integrates seamlessly into your layout.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="sidebar-example__section">
        ...
        <p className="sidebar-example__section-description">
          ...
          When collapsed, only icons are visible. Ideal for maximizing content area while keeping
        ...
        <div
          className={`sidebar-example__demo sidebar-example__demo--static sidebar-example__demo--collapsible-${collapsiblePosition}`}
        >
          {collapsiblePosition === 'left' && (
            ...
            >
              <nav className="sidebar-example__nav sidebar-example__nav--collapsible">
                <h4 className="sidebar-example__nav-title uiforge-sidebar-collapsed-hide">
                  Navigation
                </h4>
                <ul className="sidebar-example__nav-list">
                  <li>
          ...
          <div className="sidebar-example__content">
            <h4>Main Content Area</h4>
            <p>
              The collapsible sidebar lets users maximize content space while keeping navigation one
              click away. Use the toggle button on the sidebar edge or the button above to
              collapse/expand.
            </p>
        ...
        <div className="sidebar-example__features">
          ...
          <ul>
            <li>
              <code>collapsible</code> prop enables the collapse toggle button
            </li>
            <li>
              <code>collapsed</code> and <code>onCollapsedChange</code> for controlled state
            </li>
            <li>
              <code>collapsedWidth</code> sets the width when collapsed (default: 60px)
            </li>
            <li>Smooth animation transition between states</li>
            <li>Accessible toggle button with ARIA labels</li>
            <li>
              Use <code>.uiforge-sidebar-collapsed-hide</code> to hide elements when collapsed
            </li>
            <li>
              Use <code>.uiforge-sidebar-icon-only</code> to show only icons when collapsed
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="sidebar-example__section">
        ...
        <p className="sidebar-example__section-description">
          A slide-in panel for mobile and responsive layouts. Supports ESC key and backdrop click to
          close. Focus is trapped within the drawer when open.
        </p>
        ...
        >
          <div className="sidebar-example__drawer-content">
              ...
              <ul className="sidebar-example__nav-list">
                <li>
                  <a
                    href="#home"
                    onClick={() => setDrawerOpen(false)}
                    className="uiforge-sidebar-icon-only"
                  >
                    <span>🏠</span>
                    <span>Home</span>
                  </a>
            ...
            <div className="sidebar-example__drawer-footer">
              <p className="sidebar-example__hint">Press ESC or click outside to close</p>
            </div>
          </div>
        </UIForgeSidebar>
        ...
        <div className="sidebar-example__features">
          ...
          <ul>
            <li>
              <code>role="dialog"</code> and <code>aria-modal="true"</code> when open
            </li>
      ...
      <section className="sidebar-example__section">
        ...
        <p className="sidebar-example__section-description">
          A bottom sheet navigation for mobile devices. Perfect for action menus, filters, or
          additional options.
        </p>
        ...
        >
          <div className="sidebar-example__bottom-content">
            ...
            <div className="sidebar-example__action-grid">
              <button
                className="sidebar-example__action-button"
            ...
            <button className="sidebar-example__cancel-button" onClick={() => setBottomOpen(false)}>
              Cancel
            </button>
          </div>
        </UIForgeSidebar>
          ...
          <table className="sidebar-example__api-table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <code>'static' | 'drawer' | 'bottom'</code>
                </td>
                <td>
                  <code>'static'</code>
                </td>
